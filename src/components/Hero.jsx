...
const HeroData = [
  {
    ...
    title: 'Orange Fanta',
    subtitle:
      'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Architecto nostrum expedita consequuntur tenetur dolorum ratione dicta, voluptatem illo quos neque temporibus reiciendis ut earum. Nobis autem accusantium sunt deleniti ullam.',
    price: '$40',
    modal: 'Orange',
    bgColor: '#cf4f00',
  },
    ...
    <>
      ...
      >
        ...
        <div className="container grid grid-cols-1  md:grid-cols-2 min-h-[605px]">
          <div className="text-white flex flex-col justify-center py-14 md:py-0 xl:max-w-[500px] order-2 md:order-1 relative z-40">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.h1
                    ...
                    animate="show"
                    exit="exit"
                    className="text-3xl lg:text-6xl xl:text-7xl font-bold font-handwritting text-shadow"
                  >
                    {activeData.title}
                  </motion.h1>
                </UpdateFollower>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.button
                    ...
                    className="px-4 py-2 bg-white inline-block font-normal rounded-sm text-orange-400"
                  >
                    Order Now
                  </motion.button>
                </UpdateFollower>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-center !mt-6 space-y-1">
                        <p className="text-base line-through pacity-50">
                          {data.price}
                        </p>
